...
from works.weibo_sougou.settings import MODEL_LEAD_NAME
from works.weibo_sougou.settings import MULITI_MODEL_PREDICTION
from works.weibo_sougou.Function_API import Image_Processing
from works.weibo_sougou.Function_API import Distinguish_image
